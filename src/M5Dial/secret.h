...
#define SECRET_GOOGLE_APPS_SCRIPT_URL "https://script.google.com/macros/s/<Your_Script_deployment_link>/exec"
#define SECRET_GOOGLE_API_KEY "<Your_Google_API_KEY>"
...
#define SECRET_MY_RFID_TAG_NR_HEX "<Your_RFID_TAG_ID>"
